                                ...
                                <div class="col-sm-6">
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="{{ route('index') }}"><img class="media-object img-60" src="{{asset('assets/images/favicon.png')}}" alt="" /></a>
                                        </div>
                                        <div class="media-body m-l-20">
                                            <h4 class="media-heading f-w-600">StaySlay - Fashion</h4>
                                            <p>
                                                hello@viho.in<br />
                        ...
                        <div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4" style="display:flex;justify-content:flex-end;">
                                    <strong class="legal" style="text-align: left;">Payment Partners </strong>
                                    <img 
                                        src="{{asset('assets/images//paystack-logo.png')}}" alt="PayStack"
